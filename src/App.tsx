          ...
          <section className="mt-4 space-y-3">
            <article className="overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/85 p-3">
              ...
              <select
                ...
                onChange={(event) => {
                  ...
                  setTradePartnerSelection(nextSelection)
                  resetTradeSelection()
                }}
              >
                    ...
                    return (
                      <li key={`offer-${card.key}`}>
                        <button
                          ...
                          onClick={() => {
                            handleToggleTradeCard(card.key, setSelectedOfferCards)
                          }}
                        >
                    ...
                    return (
                      <li key={`request-${card.key}`}>
                        <button
                          ...
                          onClick={() => {
                            handleToggleTradeCard(card.key, setSelectedRequestCards)
                          }}
                        >
                          <span>{card.label}</span>
                          <span className="font-semibold text-zinc-200">x{card.count}</span>
            ...
            <button
              ...
              className={`h-12 w-full rounded-xl text-sm font-semibold ${
                activeTradePartner != null &&
                selectedOfferTradeCards.length > 0 &&
                selectedRequestTradeCards.length > 0
