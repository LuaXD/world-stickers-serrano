...
export const ALBUM_SECTIONS: SectionDefinition[] = [
  ...
  { code: 'MEX', name: 'Mexico', flag: '🇲🇽', stickerCount: 20, group: 'A' },
  { code: 'RSA', name: 'South Africa', flag: '🇿🇦', stickerCount: 20, group: 'A' },
  { code: 'KOR', name: 'South Korea', flag: '🇰🇷', stickerCount: 20, group: 'A' },
  { code: 'CZE', name: 'Czechia', flag: '🇨🇿', stickerCount: 20, group: 'A' },
  { code: 'CAN', name: 'Canada', flag: '🇨🇦', stickerCount: 20, group: 'B' },
  { code: 'BIH', name: 'Bosnia', flag: '🇧🇦', stickerCount: 20, group: 'B' },
  { code: 'QAT', name: 'Qatar', flag: '🇶🇦', stickerCount: 20, group: 'B' },
  { code: 'SUI', name: 'Switzerland', flag: '🇨🇭', stickerCount: 20, group: 'B' },
  { code: 'BRA', name: 'Brazil', flag: '🇧🇷', stickerCount: 20, group: 'C' },
  { code: 'MAR', name: 'Morocco', flag: '🇲🇦', stickerCount: 20, group: 'C' },
  { code: 'HAI', name: 'Haiti', flag: '🇭🇹', stickerCount: 20, group: 'C' },
  { code: 'SCO', name: 'Scotland', flag: '🏴', stickerCount: 20, group: 'C' },
  { code: 'USA', name: 'United States', flag: '🇺🇸', stickerCount: 20, group: 'D' },
  { code: 'PAR', name: 'Paraguay', flag: '🇵🇾', stickerCount: 20, group: 'D' },
  { code: 'AUS', name: 'Australia', flag: '🇦🇺', stickerCount: 20, group: 'D' },
  { code: 'TUR', name: 'Turkey', flag: '🇹🇷', stickerCount: 20, group: 'D' },
  { code: 'GER', name: 'Germany', flag: '🇩🇪', stickerCount: 20, group: 'E' },
  { code: 'CUW', name: 'Curacao', flag: '🇨🇼', stickerCount: 20, group: 'E' },
  { code: 'CIV', name: 'Ivory Coast', flag: '🇨🇮', stickerCount: 20, group: 'E' },
  { code: 'ECU', name: 'Ecuador', flag: '🇪🇨', stickerCount: 20, group: 'E' },
  { code: 'NED', name: 'Netherlands', flag: '🇳🇱', stickerCount: 20, group: 'F' },
  { code: 'JPN', name: 'Japan', flag: '🇯🇵', stickerCount: 20, group: 'F' },
  { code: 'SWE', name: 'Sweden', flag: '🇸🇪', stickerCount: 20, group: 'F' },
  { code: 'TUN', name: 'Tunisia', flag: '🇹🇳', stickerCount: 20, group: 'F' },
  { code: 'BEL', name: 'Belgium', flag: '🇧🇪', stickerCount: 20, group: 'G' },
  { code: 'EGY', name: 'Egypt', flag: '🇪🇬', stickerCount: 20, group: 'G' },
  { code: 'IRN', name: 'Iran', flag: '🇮🇷', stickerCount: 20, group: 'G' },
  { code: 'NZL', name: 'New Zealand', flag: '🇳🇿', stickerCount: 20, group: 'G' },
  { code: 'ESP', name: 'Spain', flag: '🇪🇸', stickerCount: 20, group: 'H' },
  { code: 'CPV', name: 'Cape Verde', flag: '🇨🇻', stickerCount: 20, group: 'H' },
  { code: 'KSA', name: 'Saudi Arabia', flag: '🇸🇦', stickerCount: 20, group: 'H' },
  { code: 'URU', name: 'Uruguay', flag: '🇺🇾', stickerCount: 20, group: 'H' },
  { code: 'FRA', name: 'France', flag: '🇫🇷', stickerCount: 20, group: 'I' },
  { code: 'SEN', name: 'Senegal', flag: '🇸🇳', stickerCount: 20, group: 'I' },
  { code: 'IRQ', name: 'Iraq', flag: '🇮🇶', stickerCount: 20, group: 'I' },
  { code: 'NOR', name: 'Norway', flag: '🇳🇴', stickerCount: 20, group: 'I' },
  { code: 'ARG', name: 'Argentina', flag: '🇦🇷', stickerCount: 20, group: 'J' },
  { code: 'ALG', name: 'Algeria', flag: '🇩🇿', stickerCount: 20, group: 'J' },
  { code: 'AUT', name: 'Austria', flag: '🇦🇹', stickerCount: 20, group: 'J' },
  { code: 'JOR', name: 'Jordan', flag: '🇯🇴', stickerCount: 20, group: 'J' },
  { code: 'POR', name: 'Portugal', flag: '🇵🇹', stickerCount: 20, group: 'K' },
  { code: 'COD', name: 'DR Congo', flag: '🇨🇩', stickerCount: 20, group: 'K' },
  { code: 'UZB', name: 'Uzbekistan', flag: '🇺🇿', stickerCount: 20, group: 'K' },
  { code: 'COL', name: 'Colombia', flag: '🇨🇴', stickerCount: 20, group: 'K' },
  { code: 'ENG', name: 'England', flag: '🏴', stickerCount: 20, group: 'L' },
  { code: 'CRO', name: 'Croatia', flag: '🇭🇷', stickerCount: 20, group: 'L' },
  { code: 'GHA', name: 'Ghana', flag: '🇬🇭', stickerCount: 20, group: 'L' },
  { code: 'PAN', name: 'Panama', flag: '🇵🇦', stickerCount: 20, group: 'L' },
]
